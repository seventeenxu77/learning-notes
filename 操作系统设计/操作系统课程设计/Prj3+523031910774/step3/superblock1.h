...
#define DISK_OP_WRITE 'W'
#define DISK_OP_READ  'R'
...
typedef struct {
    ...
    char data[MAX_BLOCKSIZE]; // 写入时使用，读取时可以为空
...
//total space cost:4*5+4*32+4*256+2=1174 bytes,so we should have 5 blocks
